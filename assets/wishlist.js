...
//       const handle = button.dataset.productHandle;
//       const productCard = button.closest(".card") || button.closest(".product-card");
  
//       if (!productCard) return;
  
//       const productTitle = productCard.querySelector(".card__heading a")?.innerText || "Unnamed Product";
...
//       if (itemIndex === -1) {
//         wishlist.push({ handle, title: productTitle, url: productUrl, image: productImage });
//         button.classList.add("added");
//       } else {
...
//         toggleWishlist(event.target.closest(".wishlist-btn"));
//       }
//     });
  
//     // Run this function whenever new products are loaded (like when filtering)
